...
public enum RawInput {
    ...
    public static AnalogValue getAnalogValueFromGamepad(com.qualcomm.robotcore.hardware.Gamepad ftcGamepad, RawInput gamepadEnum) throws IllegalArgumentException {
        switch (gamepadEnum) {
            case SL: {
                return new AnalogValue(ftcGamepad.left_stick_x, ftcGamepad.left_stick_y);
            }
            case SR: {
                return new AnalogValue(ftcGamepad.right_stick_x, ftcGamepad.right_stick_y);
            }
            case TL: {
                return new AnalogValue(ftcGamepad.left_trigger);
            }
            case TR: {
                return new AnalogValue(ftcGamepad.right_trigger);
            }
            default: {
    ...
    public static boolean getDigitalValueFromGamepad(com.qualcomm.robotcore.hardware.Gamepad ftcGamepad, RawInput gamepadEnum) {
        switch (gamepadEnum) {
            ...
            case DU: {
                return ftcGamepad.dpad_up;
            }
            case DD: {
                return ftcGamepad.dpad_down;
            }
            case DL: {
                return ftcGamepad.dpad_left;
            }
            case DR: {
                return ftcGamepad.dpad_right;
            }
            case BL: {
                return ftcGamepad.left_bumper;
            }
            case BR: {
                return ftcGamepad.right_bumper;
            }
            case SLB: {
                return ftcGamepad.left_stick_button;
            }
            case SRB: {
                return ftcGamepad.right_stick_button;
            }
            default: {
                throw new IllegalArgumentException();
            }
    ...
    RawInput(InputType inputType, int axes) {
        this.inputType = inputType;
        this.axes = axes;
    }
}
