...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = RobohawksMecanumDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = RobohawksMecanumDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = RobohawksMecanumDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = RobohawksMecanumDrive.HEADING_PID.kP;
        public double mecHeadingI = RobohawksMecanumDrive.HEADING_PID.kI;
        public double mecHeadingD = RobohawksMecanumDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = RobohawksMecanumDrive.LATERAL_MULTIPLIER;
